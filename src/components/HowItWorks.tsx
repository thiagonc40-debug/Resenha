    ...
    <section className="mt-space-2xl rounded-2xl bg-surface-container-low p-space-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-space-md">
        <div className="p-space-md rounded-xl bg-surface-container flex flex-col gap-space-xs">
          ...
          <p className="font-body-sm text-body-sm text-on-surface-variant">Escolha dia e horário e valide a sua reserva diretamente via WhatsApp.</p>
        </div>
        <div className="p-space-md rounded-xl bg-surface-container flex flex-col gap-space-xs">
          <span className="w-8 h-8 rounded-lg bg-primary/15 text-primary flex items-center justify-center font-label-numeric font-bold">02</span>
        ...
        <div className="p-space-md rounded-xl bg-surface-container flex flex-col gap-space-xs">
          <span className="w-8 h-8 rounded-lg bg-tertiary/15 text-tertiary flex items-center justify-center font-label-numeric font-bold">03</span>
